...
import com.broadbandmultimedia.covidinfo.view.adapter.DetailPagerAdapter
...
class DetailHospitalsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(gMapReady: GoogleMap) {
        PrimaryViewModel = ViewModelProvider(this,
            NewInstanceFactory()).get(com.broadbandmultimedia.covidinfo.viewmodel.PrimaryViewModel::class.java)
        ...
        PrimaryViewModel.getLocation().observe(this, {modelData : ModelLocationResult.ModelData ->
            ...
            googleMaps.animateCamera(CameraUpdateFactory.newLatLngZoom(LatLng(strLatitude.toDouble(), strLongitude.toDouble()), 14f))
